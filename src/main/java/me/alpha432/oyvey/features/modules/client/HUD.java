...
public class HUD extends Module {
    ...
    private final Setting<Integer> xOffset = this.register(new Setting<Object>("XOffset", Integer.valueOf(4)));
    private final Setting<Integer> yOffset = this.register(new Setting<Object>("YOffset", Integer.valueOf(2)));
    private final Setting<Integer> trOffset = this.register(new Setting<Object>("TROffset", 1, 0, 1000));
    private final Setting<Integer> yPerPlayer = this.register(new Setting<Object>("Y/Player", Integer.valueOf(18)));
    ...
    public String getDirection4D(boolean northRed) {
        return getDirection4Dh(northRed);
    }
    ...
    public static String getDirection4Dh(boolean northRed) {
    ...
    public void onRender2D(Render2DEvent event) {
        ...
        if (this.arrayList.getValue().booleanValue())
            if (this.renderingUp.getValue().booleanValue()) {
                ...
                if (this.textRadar.getValue()) {
                    this.drawTextRadar(this.getTextRadarY());
                }
        ...
        String direction = getDirection4D(false);
        String coords = coordinates;
        i += 10;
        if ((ClickGui.getInstance()).rainbow.getValue()) {
            String rainbowCoords = (inHell ? (posX + " [" + hposX + "], " + posY + ", " + posZ + " [" + hposZ + "]") : (posX + " [" + hposX + "], " + posY + ", " + posZ + " [" + hposZ + "]"));
            int[] counter2 = {1};
