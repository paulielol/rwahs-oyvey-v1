...
public class Speedmine
    ...
    public Setting<Float> range = this.register(new Setting<Object>("Range", Float.valueOf(10.0f), Float.valueOf(0.0f), Float.valueOf(50.0f), v -> this.render.getValue()));
    ...
    public Speedmine() {
        super("Speedmine", "Speeds up mining, (sometimes it doesnt)", Module.Category.PLAYER, true, false, false);
        this.setInstance();
    }
    ...
    public void onRender3D(Render3DEvent event) {
        if (this.render.getValue().booleanValue() && this.currentPos != null && (this.currentBlockState.getBlock() == Blocks.OBSIDIAN || this.currentBlockState.getBlock() == Blocks.ENDER_CHEST) && this.currentPos != null) {
            ...
            RenderUtil.drawBoxESP(this.currentPos, color, false, color, lineWidth.getValue().floatValue(), this.outline.getValue(), this.box.getValue(), this.boxAlpha.getValue(), false);
        }
    }
