...
public class Module
    ...
    public void enable() {
        ...
        if (HUD.getInstance().notifyToggles.getValue().booleanValue()) {
            TextComponentString text = new TextComponentString(ChatFormatting.BOLD + getDisplayName() + ChatFormatting.GREEN + " Enabled");
    ...
    public void disable() {
        ...
        if (HUD.getInstance().notifyToggles.getValue().booleanValue()) {
            TextComponentString text = new TextComponentString(ChatFormatting.BOLD + getDisplayName() + ChatFormatting.RED + " Disabled");
            Module.mc.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion(text, 1);
        }
        this.onToggle();
        this.onDisable();
