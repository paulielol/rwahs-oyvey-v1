...
public class AutoCrystal
    ...
    public Setting<Boolean> ghostSwitch = this.register(new Setting<Boolean>("GhostSwitch", false));
            ...
            if (!this.ignoreUseAmount.getValue().booleanValue()) {
                ...
                if (this.crystalCount < crystalLimit && this.pos != null) {
                    ...
                    if (ghostSwitch.getValue()) {
                        ...
                        InventoryUtil.mc.player.connection.sendPacket(new CPacketHeldItemChange(crystalSlot));
