...
public class DiscordPresence
{
    ...
    public static void start() {
        ...
        DiscordPresence.rpc.Discord_Initialize("832031279805235240", handlers, true, "");
        ...
        DiscordPresence.presence.largeImageKey = "oyvey";
        DiscordPresence.presence.largeImageText = "OyVey 0.0.4";
